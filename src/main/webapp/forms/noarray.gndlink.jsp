...
<%
    if (feldtyp.equals("gndlink") && !array) {
        ...
        if (gndId != null && !gndId.trim().equals("")) {
            ...
            String link = "<a class=\"ut-link ut-link--external ut-link--context-icon\" href=\"https://d-nb.info/gnd/" + DBtoHTML(gndId) + "\" target=\"_blank\" style=\"display: inline-block; vertical-align: middle;\"" + schemaOrgAttribute + "> " + gndIcon + "</a>";
            out.println(link);
        }
    }
%>
