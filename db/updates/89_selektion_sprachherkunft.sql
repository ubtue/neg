...
INSERT INTO selektion_sprachherkunft (ID, Bezeichnung) VALUES (1, 'germ(anisch)');
INSERT INTO selektion_sprachherkunft (ID, Bezeichnung) VALUES (2, 'grie(chisch)');
INSERT INTO selektion_sprachherkunft (ID, Bezeichnung) VALUES (3, 'late(inisch)');
INSERT INTO selektion_sprachherkunft (ID, Bezeichnung) VALUES (4, 'semi(tisch)');
INSERT INTO selektion_sprachherkunft (ID, Bezeichnung) VALUES (5, 'slaw(isch)');
...
INSERT INTO datenbank_mapping (Formular, Datenfeld, Feldtyp, Array, Auswahlherkunft, Seite, ZielTabelle, ZielAttribut, de_Beschriftung, gb_Beschriftung)
VALUES ('mgh_lemma', 'Sprachherkunft', 'select', 0, 'selektion_sprachherkunft', 'mghlemma', 'mgh_lemma', 'SprachherkunftID', 'Sprachherkunft', 'Language origin');

INSERT INTO datenbank_mapping (Formular, Datenfeld, Feldtyp, Array, Auswahlherkunft, Seite, ZielTabelle, ZielAttribut, de_Beschriftung, gb_Beschriftung)
VALUES ('freie_suche', 'Sprachherkunft', 'select', 0, 'selektion_sprachherkunft', 'freie_suche', 'mgh_lemma', 'SprachherkunftID', 'Sprachherkunft', 'Language origin');

# TODO: datenbank_filter, datenbank_mapping (erweiterte suche), ggf. schon experimentell vorbereitet in DB?