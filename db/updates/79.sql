...
INSERT INTO `neg`.`datenbank_mapping` (`Formular`, `Datenfeld`, `Feldtyp`, `Array`, `ZielTabelle`, `ZielAttribut`) VALUES ('quelle', 'GeschichtsquellenLink', 'geschichtsquellenlink', '0', 'quelle', 'Geschichtsquellen');
