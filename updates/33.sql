ALTER TABLE person ADD COLUMN GND varchar(255) DEFAULT NULL;

CREATE INDEX idx_gnd ON person (GND);
...
INSERT INTO datenbank_mapping (Formular, Datenfeld, Feldtyp, Array, ZielTabelle, ZielAttribut) VALUES ("person", "GNDLink", "gnd", 0, "person", "GND");