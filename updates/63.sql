...
INSERT INTO `neg`.`datenbank_mapping` (`Formular`, `Datenfeld`, `de_Beschriftung`, `Feldtyp`, `Array`, `ZielTabelle`, `FormularAttribut`, `Seite`, `gb_beschriftung`, `fr_beschriftung`, `la_beschriftung`) VALUES ('mgh_lemma', 'EinzelbelegRODistinct', 'Belegformen', 'link(einzelbeleg tab JOIN quelle q ON q.ID=tab.quelleID AND q.zuVeroeffentlichen=1,EinzelbelegID,Belegform,einzelbeleg)', '1', 'einzelbeleg_hatmghlemma', 'MGHLemmaID', 'mghlemma', 'Forms of Reference', 'Formes de référence', 'Formae testimonii');
