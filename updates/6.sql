...
ALTER TABLE gastnamenkommentar ENGINE = INNODB;
ALTER TABLE gastnamenkommentar_zweitglied ENGINE = INNODB;
ALTER TABLE gastquelle ENGINE = INNODB;
ALTER TABLE gastselektion_amtweihe_einzelbeleg ENGINE = INNODB;
ALTER TABLE gastselektion_amtweihe_person ENGINE = INNODB;
ALTER TABLE gastselektion_ethnie_einzelbeleg ENGINE = INNODB;
ALTER TABLE gastselektion_ethnie_person ENGINE = INNODB;
ALTER TABLE gastselektion_stand ENGINE = INNODB;
