...
UPDATE `datenbank_mapping` SET `de_Beschriftung` = 'Lemma' WHERE Datenfeld = 'MGHLemma' AND formular = 'freie_suche';

UPDATE `datenbank_mapping` SET `de_Beschriftung` = 'Lemma' WHERE Datenfeld = 'Ausgabe_MGHLemma' AND formular = 'freie_suche';

UPDATE `datenbank_mapping` SET `de_Beschriftung` = 'Lemma' WHERE Datenfeld = 'MGHLemmaRO' AND formular = 'einzelbeleg';
