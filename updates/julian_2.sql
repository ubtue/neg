...
VALUES ('einzelbeleg','NewAreal','combined',1,'einzelbeleg_hatareal','ArealID;ArealTypID','EinzelbelegID','selektion_areal;selektion_arealtyp','Areal;ArealTyp','select;select','einzelbeleg','Areal;ArealTyp','Areal;ArealTyp','Areal;ArealTyp','Areal;ArealTyp','Areal;ArealTyp','Areal;ArealTyp','Areal;ArealTyp','Areal;ArealTyp');
