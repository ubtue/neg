...
/*Insert values*/
INSERT INTO `neg`.`selektion_provenance` (`ID`,`Bezeichnung`) VALUES (-1,'-');
INSERT INTO `neg`.`selektion_provenance` (`ID`,`Bezeichnung`) VALUES (0,'NeG');
INSERT INTO `neg`.`selektion_provenance` (`ID`,`Bezeichnung`) VALUES (1,'DMP');
