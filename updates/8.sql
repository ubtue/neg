...
UPDATE einzelbeleg_textkritik SET HandschriftID = -1 WHERE HandschriftID NOT IN (SELECT ID FROM handschrift_ueberlieferung); /* !!! 38739/69964 ~55% !!! (about 1833 HandschriftIDs that cannot be mapped anymore). Will be set to -1 teporary and changed to NULL later. */
