...
<jsp:include page="dofilter.jsp">
     <jsp:param name="form" value="literatur" />
</jsp:include>
...
<HTML>
<HEAD>
<TITLE>Nomen et Gens - Literatur</TITLE>
...
<BODY
	onLoad="javascript:onoff('tab3','tab1'); onoff('tab1','tab3');urlRewrite(<%=id%>);">
...
<jsp:include page="layout/image.inc.html" /> <jsp:include
	...
	<jsp:param name="title" value="Literatur" />
	<jsp:param name="ID" value="<%= id %>" />
	...
	<tbody>
		...
		<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="Titel2" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
		...
		<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="LiteraturTyp" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
		...
		<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="Kurzzitierweise" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
		...
		<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="AutorJahr" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
			...
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="inLitSearch" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="inLitID" />
			</jsp:include><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="inLitSearch" />
				...
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="inLitLink" />
			</jsp:include></td>
		</tr>
				<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="inBand" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
		...
		<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="Autor" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
			...
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="Herausgeber" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
		...
		<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="Auflage" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
		...
		<tr>
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="Umfang" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
			...
			<th width="200" valign="top"><jsp:include
				page="inc.erzeugeBeschriftung.jsp">
				<jsp:param name="Formular" value="literatur" />
				<jsp:param name="Datenfeld" value="PhilologischRelevant" />
			</jsp:include></th>
			<td width="450"><jsp:include page="inc.erzeugeFormular.jsp">
				<jsp:param name="ID" value="<%= id %>" />
				<jsp:param name="Formular" value="literatur" />
...
<ul id="primary">
	...
	<li><a href="javascript:onoff('tab2','tab1');"> <jsp:include
		page="inc.erzeugeBeschriftung.jsp">
		<jsp:param name="Formular" value="literatur" />
		<jsp:param name="Textfeld" value="TabAufsaetze" />
	</jsp:include></a></li>
...
<table>
	<tr>
		...
		<td><jsp:include page="inc.erzeugeFormular.jsp">
			<jsp:param name="ID" value="<%= id %>" />
			<jsp:param name="Formular" value="literatur" />
			<jsp:param name="Datenfeld" value="SeiteNamen" />
			<jsp:param name="size" value="25" />
		</jsp:include></td>
	</tr>
</table>
...
<jsp:include page="inc.modul.jsp">
	<jsp:param name="ID" value="<%= id %>" />
	<jsp:param name="Formular" value="literatur" />
	<jsp:param name="Modul" value="aufsaetze" />
</jsp:include>
</div>
</div>
